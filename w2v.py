...
class W2V(torch.nn.Module):
    def __init__(self, model_name="wav2vec_300m", embedding_dim=256, output_dim=119, weighted_sum=False):
        ...
        if model_name == "wav2vec_300m":
            self.w2v_model = HuggingFaceWav2Vec2("facebook/wav2vec2-xls-r-300m", "./cache/", False, freeze=False, pretrain=False, weighted_sum=weighted_sum)
            ...
            self.w2v_model = HuggingFaceWav2Vec2("facebook/hubert-large-ll60k", "./cache/", False, freeze=False, pretrain=False, weighted_sum=weighted_sum)
            ...
            self.w2v_model = HuggingFaceWav2Vec2("microsoft/unispeech-sat-large", "./cache/", False, freeze=False, pretrain=False, weighted_sum=weighted_sum)
            ...
            self.w2v_model = HuggingFaceWav2Vec2("microsoft/wavlm-large", "./cache/", False, freeze=False, pretrain=False, weighted_sum=weighted_sum)
