...
def suod(embs_test, embs_train):
    from pyod.models.suod import SUOD
    from pyod.models.copod import COPOD
    from pyod.models.iforest import IForest
    # initialized a group of outlier detectors for acceleration
    #   LOF(n_neighbors=4, contamination=1e-3,metric='cosine'),
                    #   LOF(n_neighbors=10, contamination=1e-3,metric='cosine'),
                    #   LOF(n_neighbors=20, contamination=1e-3,metric='cosine'),
                    #   LOF(n_neighbors=40, contamination=1e-3,metric='cosine'),
                    #   COPOD(contamination=1e-3),
                    #   IForest(n_estimators=100, contamination=1e-3),
                    #   IForest(n_estimators=200, contamination=1e-3),
    detector_list = [ 
                      KNN(n_neighbors=1, contamination=1e-3),
                      KNN(n_neighbors=4, contamination=1e-3,),
                      KNN(n_neighbors=10, contamination=1e-3)
                    ]
